...
public class GrettingController {
    ...
    @GetMapping("/grettingError")
    public ResponseEntity<?> grettingError(){
        return ResponseEntity.ok(Collections.singletonMap("gretting", grettingService.sayHelloError("Bach", "Hello")));
    }
